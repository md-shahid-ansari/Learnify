...
const TopicImage = ({ src, alt, title }) => {
    ...
    return (
        <div
            className={`relative overflow-hidden bg-gray-300 rounded`}
            style={{ width: '300px', height: '200px' }} // Set a fixed width and height
        >
            {!isLoaded && (
            ...
            <img
                ...
                style={{ maxWidth: '100%', maxHeight: '100%' }} // Restrict image to fit within container
            />
