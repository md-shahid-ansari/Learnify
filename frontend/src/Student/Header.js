  ...
  return (
    <header className="flex justify-between items-center p-4 bg-gray-800 text-white">
      ...
      <div className="flex items-center space-x-1">
        ...
        {/* Navigation Links */}
        <Link
          to="/student-home/student-dashboard"
        ...
        <Link
          to="/student-home/student-course"
          className="bg-blue-200 hover:bg-blue-300 text-white font-semibold py-2 px-4 rounded"
        >
          <i className="fas fa-book text-xl" title="Courses"></i>
        </Link>
        <Link
          to="/student-home/student-certificate"
          className="bg-blue-200 hover:bg-blue-300 text-white font-semibold py-2 px-4 rounded"
        >
          <i className="fas fa-certificate text-xl" title="Certificates"></i>
        </Link>
        <Link
          to="/student-home/student-profile"
          className="bg-blue-200 hover:bg-blue-300 text-white font-semibold py-2 px-4 rounded"
        >
